...
<div class="contentWrapper notitle">
	<p><label>
			<?php echo elgg_echo('oi_invitefriends:introduction'); ?>
		</label>
		<textarea class="input-textarea" name="emails" ></textarea>
	</p>
	<p><label>
			<?php echo elgg_echo('oi_invitefriends:message'); ?>
		</label>
		<textarea class="input-textarea" name="emailmessage" >
<?php

echo sprintf(elgg_echo('oi_invitefriends:message:default'),$CONFIG->site->name);
