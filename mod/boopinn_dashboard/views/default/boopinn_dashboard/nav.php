...
switch($vars['orient']) {
	case '':
		...
		break;
	case 'teams':
		$teamsselect = 'class="selected"';
		break;
	case 'openlab':
		$openlabselect = 'class="selected"';
		break;
	case 'mine':
...
?>
	<div id="elgg_horizontal_tabbed_nav">
		<ul>
			<li <?php echo $allselect; ?> ><a onclick="javascript:$('#river_container').load('<?php echo $vars['url']; ?>mod/riverdashboard/?content=<?php echo $vars['type']; ?>,<?php echo $vars['subtype']; ?>&amp;callback=true'); return false;" href="?display="><?php echo elgg_echo('All Network Updates'); ?></a></li>
			<li <?php echo $teamsselect; ?> ><a onclick="javascript:$('#river_container').load('<?php echo $vars['url']; ?>mod/riverdashboard/?display=teams&amp;content=<?php echo $vars['type']; ?>,<?php echo $vars['subtype']; ?>&amp;callback=true'); return false;" href="?display=teams"><?php echo elgg_echo('teams'); ?></a></li>
			<li <?php echo $openlabselect; ?> ><a onclick="javascript:$('#river_container').load('<?php echo $vars['url']; ?>mod/riverdashboard/?display=openlab&amp;content=<?php echo $vars['type']; ?>,<?php echo $vars['subtype']; ?>&amp;callback=true'); return false;" href="?display=openlab"><?php echo elgg_echo('openlab'); ?></a></li>
