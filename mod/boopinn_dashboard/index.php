...
//$content = elgg_view('page_elements/contentwrapper', array('body' => $nav . $river));
	...
	$body = elgg_view('boopinn_dashboard/container', array('request' => $notif_request,'teams_activity'=>$my_team_activity,'openlabs_activity'=>$my_openlab_activity,'cis_activity'=>$my_cis_activity,'follow_activity'=>$my_follow_activity));
