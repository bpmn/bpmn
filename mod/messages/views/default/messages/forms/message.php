...
require_once(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__)))))) . "/mycis/actions/cis.php");


// find users in my cis 
...
if ($send_to) {
    ...
    ?>
            ...
            <p><label><?php echo elgg_echo("messages:to"); ?>: </label>
                ...
                <select name='send_to'>
            <?php
            echo "<option value='-1'>".elgg_echo('message:selectuser')."</option>";
            foreach ($myCis as $friend) {
