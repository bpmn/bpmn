        ...
        ?>
		        ...
		        <?php
			        ...
			        echo elgg_view("output/confirmlink",array(
														'href' => $vars['url'] . "action/teams/deletepost?post=" . $vars['entity']->id . "&topic=" . get_input('topic') . "&group=" . get_input('group_guid'),
...
?>
				...
				<?php
					echo elgg_view('input/form', array('action' => "{$vars['url']}action/teams/editpost", 'body' => $form_body, 'internalid' => 'editforumpostForm'));
				?>
					</div>
		        </p>
