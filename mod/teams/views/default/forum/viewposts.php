<?php
    ...
    /**
	 * Elgg teams plugin display topic posts
	 * 
	 * @package ElggGroups
	 */
...
<div id="pages_breadcrumbs"><b><a href="<?php echo $vars['url']; ?>pg/teams/forum/<?php echo $vars['entity']->container_guid; ?>/"><?php echo elgg_echo("teams:forum"); ?></a></b> > <?php echo $vars['entity']->title; ?></div>
...
<?php
    ...
    if($vars['entity']->status != "closed" && page_owner_entity()->isMember($vars['user'])){
        ...
        echo "<h2>" . elgg_echo("teams:topicisclosed") . "</h2>";
        echo "<p>" . elgg_echo("teams:topiccloseddesc") . "</p>";
