<?php
	...
	// new teams default to open membership
...
<form action="<?php echo $vars['url']; ?>action/teams/edit" enctype="multipart/form-data" method="post">

	<?php echo elgg_view('input/securitytoken'); ?>

	<p>
		<label><?php echo elgg_echo("teams:icon"); ?><br />
		<?php
...
?>
	...
	<p>
		<label>
			<?php echo elgg_echo("teams:{$shortname}") ?><br />
...
<!--	<p>
		<label>
			<?php //echo elgg_echo('teams:membership'); ?><br />
			<?php //echo elgg_view('input/access', array('internalname' => 'membership','value' => $membership, 'options' => array( ACCESS_PRIVATE => elgg_echo('teams:access:private'), ACCESS_PUBLIC => elgg_echo('teams:access:public')))); ?>
		</label>
	</p> -->
...
?>
	...
	<p>
		<label>
			<?php echo elgg_echo('teams:visibility'); ?><br />
			<?php 
			...
			<label>
				...
				<?php
					...
					//echo elgg_view("input/radio",array(
								...
								//	'options' => array(
								//						elgg_echo('teams:yes') => 'yes',
								//						elgg_echo('teams:no') => 'no',
								//					   ),
								//					));
				?>
			</label>
	...
	<form action="<?php echo $vars['url'] . "action/teams/delete"; ?>">
		<?php
			echo elgg_view('input/securitytoken');
				$warning = elgg_echo("teams:deletewarning");
			?>
			<input type="hidden" name="group_guid" value="<?php echo $vars['entity']->getGUID(); ?>" />
			<input type="submit" name="delete" value="<?php echo elgg_echo('teams:delete'); ?>" onclick="javascript:return confirm('<?php echo $warning; ?>')"/>
	</form>
