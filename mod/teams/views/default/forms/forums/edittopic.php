<?php
	...
	// set the title
	    echo elgg_view_title(elgg_echo("teams:edittopic"));
	 
?>
<div class="contentWrapper">
<!-- display the input form -->
	<form action="<?php echo $vars['url']; ?>action/teams/edittopic" method="post">
	<?php echo elgg_view('input/securitytoken'); ?>
		...
		<p class="longtext_editarea">
			<label><?php echo elgg_echo("teams:topicmessage"); ?><br />
			<?php
		...
		<p>
		    <label><?php echo elgg_echo("teams:topicstatus"); ?><br />
		    <select name="status">
		        <option value="open" <?php if($status == "") echo "SELECTED";?>><?php echo elgg_echo('teams:topicopen'); ?></option>
		        <option value="closed" <?php if($status == "closed") echo "SELECTED";?>><?php echo elgg_echo('teams:topicclosed'); ?></option>
		    </select>
		    </label>
		</p>
