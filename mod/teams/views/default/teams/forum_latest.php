...
<h2><?php echo elgg_echo('teams:latestdiscussion'); ?></h2>
<?php
    ...
    if($forum){
        foreach($forum as $f){
    	        ...
    	        echo "<div class=\"topic_title\"><p><a href=\"{$f->getURL()}\">" . $f->title . "</a></p> <p class=\"topic_replies\"><small>".elgg_echo('teams:posts').": " . $count_annotations . "</small></p></div>";
