		...
		<div class="teams_membershiprequest_buttons">
			<?php
				...
				echo str_replace('<a', '<a class="delete_report_button" ', elgg_view('output/confirmlink',array(
					'href' => $vars['url'] . 'action/teams/killrequest?user_guid='.$request->guid.'&group_guid=' . $vars['entity']->guid,
					'confirm' => elgg_echo('teams:joinrequest:remove:check'),
...
<?php
		...
		echo "<p>" . elgg_echo('teams:requests:none') . "</p>";
