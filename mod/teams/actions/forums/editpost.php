<?php
    ...
    /**
	 * Elgg teams plugin edit post action.
	 * 
	 * @package ElggGroups
	 */
	...
	//get the required variables
		...
		if ($annotation) {
			...
			if (teams_can_edit_discussion($annotation, page_owner_entity()->owner_guid)) {
				
				update_annotation($post, "group_topic_post", $post_comment, "",$commentOwner, $access_id);
			    system_message(elgg_echo("teams:forumpost:edited"));
				   
			} else {
				system_message(elgg_echo("teams:forumpost:error"));
			}
