...
<form action="<?php echo $vars['url']; ?>action/profile/invite" method="post">
	...
	$groups_viewer = elgg_get_entities_from_relationship($options);
        ...
        if ($groups_viewer) {
            ...
            echo elgg_view('input/checkboxes',array('internalname' => 'group_guid_openlab', 'default'=>'','options'=>$list));

        } 

        $options['subtypes']='teams';
        $groups_viewer = elgg_get_entities_from_relationship($options);
        ...
        if ($groups_viewer) {
            ...
            echo elgg_view('input/checkboxes',array('internalname' => 'group_guid_team', 'default'=>'','options'=>$list));
