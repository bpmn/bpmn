...
//HACK -configuration to select default view
$save=false;
		if ($orient=='') $orient = get_plugin_usersetting("orient", 0,"riverdashboard");
		if (!$orient) { $orient = get_plugin_setting("orient","riverdashboard"); $save=true; }
		if (!$orient) $orient="all";

		if ($save) set_plugin_usersetting("orient",$orient,0,"riverdashboard");
...
$body .=elgg_view("riverdashboard_wire/refresh");
if ($thewireon == 'yes'){
