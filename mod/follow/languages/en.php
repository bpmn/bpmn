<?php
	/**
	 * Elgg follow plugin language pack
	 *
	 * @package Elggteams
	 */
	...
	$english = array(
		 ...
		 */
			...
			'follow' => "Follow",
                        ...
                        'follow:openlabs'=>"OpenLabs",
                        'follow:teams'=>"Teams",
                        'follow:count'=>"You are  following %s %s",
                        'follow:isfollowing'=>"%s is following...",
                        'follow:this'=>"Follow",
                        'follow:stopfollow'=>"You are not following %s anymore"
