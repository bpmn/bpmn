                ...
                <td width="70%">       
                    <?php
                       ...
                       echo parse_urls(elgg_view("output/longtext",array("value" => $vars['entity']->value)));
                         ...
                         echo elgg_view("output/iconurl",array(
        ...
        ?>
		        ...
		        <?php
			        ...
			        echo elgg_view("output/confirmlink",array(
														'href' => $vars['url'] . "action/openlabs/deletepost?post=" . $vars['entity']->id . "&topic=" . get_input('topic') . "&openlab=" . get_input('openlab_guid'),
                	...
                	$topic = elgg_view('input/hidden', array('internalname' => 'topic', 'value' => get_input('topic')));
		  			$openlab = elgg_view('input/hidden', array('internalname' => 'openlab', 'value' => get_input('openlab_guid')));
