...
#topic_posts #content_area_openlab_title h2 {
	margin:0 0 0 0;
}
...
#openlabs_info_column_left {
	width:435px;
	margin-left:230px;
	margin-right:10px;
}

#openlabs_info_column_left .odd {
	background:#E9E9E9;
	-webkit-border-radius: 5px; 
	-moz-border-radius: 5px;
}
#openlabs_info_column_left .even {
	background:#E9E9E9;
	-webkit-border-radius: 5px; 
	-moz-border-radius: 5px;
}
#openlabs_info_column_left p {
	margin:0 0 7px 0;
	padding:2px 4px;
}

#openlabs_info_column_right {
	float:left;
	width:230px;
	margin:0 0 0 10px;
}
#openlabs_info_wide p {
	text-align: right;
	padding-right:10px;
}
#openlab_stats {
...
/* openlab pages widget */
#openlab_pages_widget {
	margin:0 0 20px 0;
	padding: 0 0 5px 0;
	background:white;
	-webkit-border-radius: 8px; 
...
.openlabs .openlab_count {
	font-weight: bold;
	color: #666666;
	margin:0 0 5px 4px;
}
.openlabs .search_listing_info {
	color:#666666;
}
.openlabdetails {
	float:right;
...
#openlabs_closed_membership p {
	margin:0;
}

/* openlabs membership widget */
.openlabmembershipwidget .contentWrapper {
	margin:0 10px 5px 10px;
}
.openlabmembershipwidget .contentWrapper .openlabicon {
	float:left;
	margin:0 10px 0 0;
}
.openlabmembershipwidget .search_listing_info p {
	color: #666666;
}
.openlabmembershipwidget .search_listing_info span {
	font-weight: bold;
}

/* openlabs sidebar */
.featuredopenlabs .contentWrapper {
	margin:0 0 10px 0;
}
.featuredopenlabs .contentWrapper .openlabicon {
	float:left;
	margin:0 10px 0 0;
}
.featuredopenlabs .contentWrapper p {
	margin: 0;
	line-height: 1.2em;
	color:#666666;
}
.featuredopenlabs .contentWrapper span {
	font-weight: bold;
}
#openlabssearchform {
...
#openlabssearchform input[type="submit"] {
	padding:2px;
	height:auto;
	margin:4px 0 5px 0;
}
...
/* delete openlab button */
#delete_openlab_option input[type="submit"] {
	background:#dedede;
	border-color:#dedede;
	color:#333333; 
	margin:0;
...
#delete_openlab_option input[type="submit"]:hover {
	background:red;
	border-color:red;
	color:white;
}

#openlabsearchform .search_input {
	width:176px;
}

#openlabs_member_link {
	padding-bottom: 5px;
	text-align: center;
}
