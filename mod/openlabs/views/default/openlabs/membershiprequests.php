...
?>
	<div class="reportedcontent_content active_report">
		<div class="openlabs_membershiprequest_buttons">
			...
			$url = elgg_add_action_tokens_to_url("{$vars['url']}action/openlabs/addtoopenlab?user_guid={$request->guid}&openlab_guid={$vars['entity']->guid}");
			?>
...
<?php
		...
		echo "<p>" . elgg_echo('openlabs:requests:none') . "</p>";
