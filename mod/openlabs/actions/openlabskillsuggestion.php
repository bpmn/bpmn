<?php
	/**
	 * Delete an suggestion to join a closed openlab.
	 *
	...
	// If join request made
			if (check_entity_relationship($openlab->guid, 'suggested', $user->guid))
			{
				remove_entity_relationship($openlab->guid, 'suggested', $user->guid);
				system_message(elgg_echo("openlabs:suggestkilled"));
			}
