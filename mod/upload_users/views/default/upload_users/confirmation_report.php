...
$(document).ready(function(){
	...
	$('#cancel_button').click(function(){
		window.location = '<?php echo $CONFIG->wwwroot; ?>pg/upload_users/';
	});
...
<form action="<?php echo $CONFIG->wwwroot; ?>mod/upload_users/upload.php" method="POST" id="confirmation_form">
...
<input type="hidden" name="email" id="email" value="<?php echo $vars['email']; ?>">
...
&nbsp;<input type="button" id="cancel_button" class="submit_button" value="<?php echo elgg_echo('cancel'); ?>">
</form>
