...
function requestnotifications_page_handler($page) {
    ...
    switch ($page[0]) {
        case 'team' : {
                page_draw(elgg_echo('requestnotifications:title'), elgg_view_layout('two_column_left_sidebar', '', elgg_view('requestnotifications/detailedteam')));
                break;
            }
        case 'openlab' : {
                page_draw(elgg_echo('requestnotifications:title'), elgg_view_layout('two_column_left_sidebar', '', elgg_view('requestnotifications/detailedopenlab')));
                break;
            }
    };
