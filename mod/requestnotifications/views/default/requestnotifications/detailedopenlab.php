...
<div class="requestnotifications_wrapper">
	...
	// Group membership requests
		...
		if ($owned_groups) {
			...
			if ($content != "") { ?>
			<div class="requestnotifications_box">
				<h3 class="grouprequestscount"><?php echo elgg_echo('requestnotifications:openlabrequests:title'); ?></h3>				
				<?php echo $content; ?>
				<div class='clearfloat'></div>
			</div>
		  <?php
	...
	// Group invitations
		...
		if (isset($num_invitations) and $num_invitations > 0)  {
			...
			?>
			<div class="requestnotifications_box">
					<h3 class="groupinvitationscount"><?php echo elgg_echo('requestnotifications:groupinvite:title'); ?></h3>
					<?php echo $content; ?>
					<div class='clearfloat'></div>
			</div>	
			<?php
